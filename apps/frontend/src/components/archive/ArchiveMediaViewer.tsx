...
export function ArchiveMediaViewer({ itemId, fileType, canView }: ArchiveMediaViewerProps) {
    ...
    return (
      <div style={{ ...shellStyle, height: 200 }}>
        <div style={{ textAlign: "center", padding: 24 }}>
          <Lock size={28} color="#d1d5db" style={{ margin: "0 auto 10px" }} />
          <p style={{ fontSize: 13, fontWeight: 600, color: "#374151", margin: 0 }}>Preview unavailable</p>
          <p style={{ fontSize: 12, color: "#9ca3af", marginTop: 4 }}>This document isn&apos;t published yet or you don&apos;t have access.</p>
        </div>
      </div>
    );
  }
  ...
  if (failed || !url) {
    return (
      <div style={{ ...shellStyle, height: 200 }}>
        <div style={{ textAlign: "center", padding: 24 }}>
          <File size={28} color="#d1d5db" style={{ margin: "0 auto 10px" }} />
          <p style={{ fontSize: 13, fontWeight: 600, color: "#374151", margin: 0 }}>Preview unavailable</p>
        </div>
      </div>
    );
  ...
  if (kind === "image") {
    return (
      <div style={{ borderRadius: 12, overflow: "hidden", border: "1px solid #e5e7eb", background: "#f9fafb", textAlign: "center" }}>
  ...
  return (
    <div style={{ ...shellStyle, height: 160 }}>
      <div style={{ textAlign: "center", padding: 24 }}>
        ...
        <p style={{ fontSize: 13, fontWeight: 600, color: "#374151", margin: 0 }}>No in-browser preview for this file type</p>
        <p style={{ fontSize: 12, color: "#9ca3af", marginTop: 4 }}>Use the Download button below to view it.</p>
      </div>
    </div>
  );
}
